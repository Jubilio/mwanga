...
router.get('/generate-registration-options', authenticate, webauthnController.generateRegistration);
router.post('/verify-registration', authenticate, webauthnController.verifyRegistration);
